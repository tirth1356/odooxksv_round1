...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        q1 = Quotation.objects.create(
            ...
            total_price=Decimal("87000.00"),
            delivery_days=5,
            vendor_notes="Bulk discount applied. ISO certified materials.",
            status="Selected",
        )
        q2 = Quotation.objects.create(
            rfq=rfq,
            vendor=v2,
            price_per_unit=Decimal("6300.00"),
            total_price=Decimal("94500.00"),
            delivery_days=8,
            vendor_notes="IT-grade ergonomic furniture with extended warranty.",
            status="Submitted",
        )
        q3 = Quotation.objects.create(
            rfq=rfq,
            vendor=v3,
            price_per_unit=Decimal("7333.33"),
            total_price=Decimal("110000.00"),
            delivery_days=12,
            vendor_notes="Standard office-grade furniture, COD terms only.",
            status="Rejected",
        )
        ...
        po = PurchaseOrder.objects.create(
            ...
            status="Issued",
            subtotal=Decimal("169500.00"),
            grand_total=Decimal("169500.00"),
        )
        POItem.objects.create(purchase_order=po, description="Ergonomic chair", qty=25, price=Decimal("5500.00"), total=Decimal("137500.00"))
        POItem.objects.create(purchase_order=po, description="Standing desks", qty=10, price=Decimal("3200.00"), total=Decimal("32000.00"))

        POTimelineEvent.objects.create(purchase_order=po, title="RFQ Created by Officer", completed=True)
        POTimelineEvent.objects.create(purchase_order=po, title="Bids Submitted by Infra Supplies", completed=True)
        ...
        inv = Invoice.objects.create(
            ...
            subtotal=Decimal("169500.00"),
            cgst=Decimal("15255.00"),
            sgst=Decimal("15255.00"),
            grand_total=Decimal("200010.00"),
        )
        InvoiceItem.objects.create(invoice=inv, description="Ergonomic chair", qty=25, price=Decimal("5500.00"), total=Decimal("137500.00"))
        InvoiceItem.objects.create(invoice=inv, description="Standing desks", qty=10, price=Decimal("3200.00"), total=Decimal("32000.00"))
        ...
        ActivityLog.objects.create(
            ...
            description="Admin verified 'Techcore LTD' as an active supplier.",
            category="Vendors",
        )
        ActivityLog.objects.create(
            user=officer_user,
            title="RFQ Created",
            description="Procurement Officer created RFQ 'Office Furniture procurement Q2'.",
            category="RFQs",
        )
        ActivityLog.objects.create(
            user=manager_user,
