...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # --- SECOND PO and INVOICE FOR GLOBAL TECH ---
        po2 = PurchaseOrder.objects.create(
            ...
            grand_total=Decimal("850000.00"),
        )
        POItem.objects.create(purchase_order=po2, description="Cloud Migration Services", qty=1, price=Decimal("850000.00"), total=Decimal("850000.00"))
        ...
        inv2 = Invoice.objects.create(
            ...
            status="Pending Payment",
            subtotal=Decimal("850000.00"),
            cgst=Decimal("76500.00"),
            sgst=Decimal("76500.00"),
            grand_total=Decimal("1003000.00"),
        )
        InvoiceItem.objects.create(invoice=inv2, description="Cloud Migration Services", qty=1, price=Decimal("850000.00"), total=Decimal("850000.00"))
        
        # --- THIRD PO FOR STARK INDUSTRIES ---
        ...
        POItem.objects.create(purchase_order=po3, description="Armored Security Vehicles", qty=3, price=Decimal("500000.00"), total=Decimal("1500000.00"))
