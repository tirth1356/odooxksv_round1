        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="glass-panel p-6 rounded-xl relative overflow-hidden">
            ...
            <div className="flex flex-col gap-1">
              <p className="font-title-sm text-title-sm text-on-surface">Data Center Infrastructure Upgrade Q3</p>
              <p className="text-on-surface-variant font-body-md">Enterprise Blade Servers × 5, Network Switches × 2, NVMe Storage × 40 — Category: IT Infrastructure & Hardware</p>
            </div>
          </section>
